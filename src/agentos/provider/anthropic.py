                ...
                async with client.stream(
                    ...
                    async for line in response.aiter_lines():
                        ...
                        if etype == "message_start":
                            ...
                            # ``usage`` and ``delta.stop_reason`` are each
                            # optional on this event. Last write wins, but a
                            # write only happens when the field is actually
                            # carried: overwriting unconditionally zeroed the
                            # totals and reset stop_reason to "end_turn".
                            ...
                            delta_stop = (event.get("delta") or {}).get("stop_reason")
