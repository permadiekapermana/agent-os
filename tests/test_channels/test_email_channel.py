...
def test_exchange_oof_and_autogenerated_headers_are_treated_as_automated() -> None:
    assert is_automated(_raw(extra_headers={"X-Auto-Response-Suppress": "OOF"})) is True
    assert is_automated(_raw(extra_headers={"X-Auto-Response-Suppress": "All"})) is True
    assert is_automated(_raw(extra_headers={"X-Autogenerated": "Reply"})) is True
    assert is_automated(_raw(extra_headers={"X-Autogenerated": "Forward"})) is True


def test_exchange_headers_none_are_not_treated_as_automated() -> None:
    assert is_automated(_raw(extra_headers={"X-Auto-Response-Suppress": "none"})) is False
    assert is_automated(_raw(extra_headers={"X-Autogenerated": "none"})) is False
